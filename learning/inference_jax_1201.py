...
def main():
    ...
    sim_data_init_min_snap = np.loadtxt(
        "/workspace/rotorpy/rotorpy/data_out/" + fname_minsnap + ".csv",
        delimiter=",",
        skiprows=1,
    )
    ...
    sim_data_modified = np.loadtxt(
        "/workspace/rotorpy/rotorpy/data_out/" + fname_nn + ".csv",
        delimiter=",",
        skiprows=1,
    )
    ...
    title = "ref=nn_coeff"
    axes.set_title(title)
    plt.savefig("/workspace/rotorpy/rotorpy/sim_figures/nn_traj.png")
    # plt.show()
    ...
    plt.savefig("/workspace/rotorpy/rotorpy/sim_figures/nn_yaw_actual.png")
    # plt.show()
