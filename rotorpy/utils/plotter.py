...
class Plotter:
    ...
    def plot_results(self, plot_mocap, plot_estimator, plot_imu):
        ...
        (fig, axes) = plt.subplots(
            nrows=2, ncols=1, sharex=True, num="Attitude/Rate vs Time"
        )
        ax = axes[0]
        ax.plot(
            self.time,
        ...
        if plot_mocap:  # if mocap should be plotted.
            ...
            (fig, axes) = plt.subplots(
                nrows=2, ncols=1, sharex=True, num="Motion Capture Pos/Vel vs Time"
            )
            ax = axes[0]
            ax.plot(
                self.time,
            ...
            (fig, axes) = plt.subplots(
                ...
                ncols=1,
                sharex=True,
                num="Motion Capture Attitude/Rate vs Time",
            )
            ax = axes[0]
            ax.plot(
                self.time,
        ...
        # Commands vs. Time
        (fig, axes) = plt.subplots(
            nrows=3, ncols=1, sharex=True, num="Commands vs Time"
        )
        ax = axes[0]
        ax.plot(
            self.time,
        ...
        if plot_imu:
            (fig, axes) = plt.subplots(
                nrows=2, ncols=1, sharex=True, num="IMU Measurements vs Time"
            )
            ax = axes[0]
            ax.plot(
                self.time,
        ...
        if plot_estimator:
            if self.estimator_exists:
                ...
                (fig, axes) = plt.subplots(
                    nrows=N_filter, ncols=1, sharex=True, num="Filter States vs Time"
                )
